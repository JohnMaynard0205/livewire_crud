    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label for="attachment" class="col-md-4 col-form-label text-md-end text-start">
                        <strong>Product Image:</strong>
                    </label>
                    <div class="col-md-6" style="line-height: 35px;">
                        @if($product->attachment)
                            <div class="mt-2">
                                <img src="{{ asset('uploads/' . $product->attachment) }}" alt="{{ $product->name }}" class="img-fluid border rounded" style="max-width: 300px; max-height: 300px; object-fit: cover;">
                            </div>
                        @else
